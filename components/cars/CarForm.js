        ...
        {successMsg && (
            ...
            >
                ...
                <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-gray-200 pb-6">
                    ...
                    <Input label="Mileage (km)" name="mileage" value={formData.mileage} onChange={handleChange} />
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        />
                        <label htmlFor="usedCheckbox" className="text-sm font-medium text-gray-700 cursor-pointer">
                            Used Car
                        </label>
                    </div>
                </fieldset>
                ...
                <fieldset className="border-b border-gray-200 pb-6 space-y-3">
                    <legend className="text-xl font-semibold text-gray-700">Extras</legend>
                ...
                <fieldset className="border-b border-gray-200 pb-6">
                    <legend className="text-xl font-semibold text-gray-700 mb-3">Seller Comments</legend>
                    <textarea
                        name="sellerComments"
                ...
                <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <legend className="text-xl font-semibold text-gray-700 mb-4 md:col-span-2">Vehicle Details</legend>
